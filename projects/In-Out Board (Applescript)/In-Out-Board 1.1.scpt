...
set ViewOption to button returned of (display dialog "Welcome to In-Out-Board" buttons {"View All Users", "View Specific Users", "Quit"} default button "Quit")

if ViewOption is equal to "View Specific Users" then
